...
(function($){
	...
	$(document).ready(function(){
		...
		$('.all_around_font_button').on('click', function(){
		...
		$('.all_around_duplicate_subitem').on('click',function(e){
			e.preventDefault();
			e.stopPropagation();
		...
		$('.all_around_delete_subitem').on('click',function(e){
			e.preventDefault();
			e.stopPropagation();
		...
		$('.all_around_delete_group').on('click',function(e){
			e.preventDefault();
			e.stopPropagation();
