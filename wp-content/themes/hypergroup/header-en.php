...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <title>Hyper group - Web developpement & digital communication agency in Tunisia</title>
        <meta name="description" content="Hyper group is a group of companies and agencies specializing in web development and digital marketing solutions in Tunisia">
        ...
        <div class="l-theme animated-css" data-header="sticky" data-header-top="200" data-canvas="container">
            ...
            <div data-off-canvas="mobile-slidebar left overlay">
                <ul class="yamm main-menu nav navbar-nav">
                    <li>
                        <a href="https://hypergroup.com.tn/?lang=en#home">
                            <?php _e( 'Home', 'hypergroup' ); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://hypergroup.com.tn/?lang=en#apropos">
                            <?php _e( 'About Us', 'hypergroup' ); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://hypergroup.com.tn/?lang=en#apropos">
                            <?php _e( 'Partenship', 'hypergroup' ); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://hypergroup.com.tn/?lang=en#services">
                            <?php _e( 'Our services', 'hypergroup' ); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://hypergroup.com.tn/?lang=en#clients">
                            <?php _e( 'Our clients', 'hypergroup' ); ?>
                        </a>
                    </li>
                    <li class="dropdown"><a class="dropdown-toggle" href="#ref">Our works</a>
                        <ul class="dropdown-menu">
                            <li><a href="https://hypergroup.com.tn/references/websites-developement/?lang=en">Websites development</a></li>
                            <li><a href="https://hypergroup.com.tn/references/graphic-design/?lang=en">Graphic design</a></li>
                            <li><a href="https://hypergroup.com.tn/references/audio-visual/?lang=en">Audio-visual production</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="https://hypergroup.com.tn/contact-us/?lang=en">
                            <?php _e( 'Contact Us', 'hypergroup' ); ?>
                        </a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="container container-boxed-width h_top_part">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <ul class="top_bar_info" id="top_bar_info_1" style="display: block;">
                                <li><i class="fa fa-phone"></i> Phone1.: +216 74 408 885</li>
                                <li><i class="fa fa-fax"></i> Phone2.: +216 70 296 336</li>
                                <li><i class="fa fa-clock-o"></i> Mon-Fri 9.00 AM - 06.00 PM </li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="container container-boxed-width">
                    ...
                    <nav class="navbar" id="nav">
                        <div class="header-navibox-1">
                            ...
                            <!-- Mobile Trigger End-->
                            <a class="navbar-brand scroll" href="https://hypergroup.com.tn/?lang=en">
                                <img class="normal-logo" src="https://hypergroup.com.tn/wp-content/uploads/2022/03/logo-hypergroup-1.png" alt="logo">
                                <img class="scroll-logo hidden-xs" src="https://hypergroup.com.tn/wp-content/uploads/2022/03/logo-hypergroup-1.png" alt="logo">
                            </a>
                        </div>
                        <div class="header-navibox-2">
                            <ul class="yamm main-menu nav navbar-nav">
                                ...
                                <li>
                                    <a href="https://hypergroup.com.tn/?lang=en#partenariat">
                                        <?php _e( 'Partenship', 'hypergroup' ); ?>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li class="dropdown"><a class="dropdown-toggle" href="#ref">Our works</a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="https://hypergroup.com.tn/references/graphic-design/?lang=en">Graphic design</a></li>
                                        <li><a href="https://hypergroup.com.tn/references/audio-visual/?lang=en">Audio-visual production</a></li>
                                        <li><a href="https://hypergroup.com.tn/references/community-management-en/?lang=en">Community management</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="https://hypergroup.com.tn/contact-us/?lang=en">
